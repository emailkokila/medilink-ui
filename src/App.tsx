...
import ClinicianLogin from "./pages/clinician-login/ClinicianLogin";
import ClinicianAppointments from "./pages/clinician-appointments/ClinicianAppointments";
            ...
            <div className="App">
              <main>
                <Routes>
                    ...
                    <Route path="/clinician-login" element={<Layout><ClinicianLogin /></Layout>} />
